 ...
 */
BackgroundDownloader.prototype.createDownload = function(uri, resultFile, notificationTitle, domain) {
    return new DownloadOperation(uri, resultFile, this.uriMatcher, notificationTitle, domain);
};
